  ...
  export default{
    ...
    data(){
      return{
        ...
        count:0,//商品结算数量
        checkedItem:{},//选中的商品对象
        userAction:'',//用户s行为 0 新增 1编辑 2删除
        showDelModal:false,//是否显示删除弹框
        showEditModal:false,//是否显示新增和编辑弹框
    ...
    methods:{
      ...
      getCarList(){
          ...
          let list=res.cartProductVoList;//获取购物车中所有的商品
          this.cartTotalPrice=res.cartTotalPrice//当前选中商品总金额
